...
# ================= PHASE 1.5 TIME FILTER =================
# Derived strictly from time-of-day analysis
...
def main():
    print("Loading CSV data (Phase 1.5 – Time Filtered)...")
    ...
    trades.to_csv(
        os.path.join(OUTPUT_DIR, "scenario3_phase1_5_trades.csv"),
        index=False
    )

    pd.DataFrame([summary]).to_csv(
        os.path.join(OUTPUT_DIR, "scenario3_phase1_5_summary.csv"),
        index=False
    )

    print("Phase 1.5 backtest completed")
    print(summary)
